...
public class Skelebash1 extends BasicGameState {
    ...
    Music gamesong = new Music("res/Darude_-_Sandstorm.ogg");
    ...
    public void render(GameContainer gc, StateBasedGame sbg, Graphics g)
        ...
        g.drawString("Score: " + player.getkillCounter(), camera.cameraX + 10,
                camera.cameraY + 40);
        g.drawString("x: " + (int)player.x + "y: " +(int)player.y , player.x, player.y - 55);
        g.draw(player.rect);
        g.drawString("inventory: " + player.getInv(), camera.cameraX + 600, camera.cameraY);
        if (orb1.isIsVisible()) {
